...
class activity_Paylastiklarim : AppCompatActivity() {
    ...
    lateinit var myAdapter: class_paylastiklarim_adop
    ...
    fun init() {
        ...
        myAdapter = class_paylastiklarim_adop(this, fun_paylasilanlari_getir())

        rcy_paylastiklarim.adapter = myAdapter

        var linearLayoutManager = LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false)
        rcy_paylastiklarim.layoutManager = linearLayoutManager
        ...
        AutStateLis = object : FirebaseAuth.AuthStateListener {
            override fun onAuthStateChanged(p0: FirebaseAuth) {
                if (p0.currentUser != null) {
                    ...
                    var intentim = Intent(this@activity_Paylastiklarim, LoginActivity::class.java)
    ...
    fun fun_paylasilanlari_getir(): ArrayList<class_vt_paylasimlar> {
        ...
        sorgu.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onCancelled(p0: DatabaseError) {
                ...
                Toast.makeText(this@activity_Paylastiklarim, "Hata oluştu: " + p0.message, Toast.LENGTH_SHORT).show()
            }
            ...
            override fun onDataChange(p0: DataSnapshot) {
                ...
                for (veriler in p0!!.children) {
                   ...
                   if(okunan.kullanici_id.toString().equals( Kullanici!!.uid.toString()))
                ...
                if(tum_paylasilanlar.size<=0){
                    lbl_paylastiklrim_sayi.setText("Sistemde paylaşımınız bulunamadı...")


                }else{

                    lbl_paylastiklrim_sayi.setText("Sistemde kayıtlı olan paylaşım sayınız: "+tum_paylasilanlar.size.toString())
